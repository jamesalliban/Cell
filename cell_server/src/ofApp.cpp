...
bool ofApp::isKinectAttached;
bool ofApp::isAllUserDebugVisible;
...
////    {
////        isLoadingXml = true;
////        printf("- ofApp::checkNewTagIndex() loading tag index \n");
